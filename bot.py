...
# ১. ফ্লাস্ক অ্যাপ তৈরি (রেন্ডার ফ্রি ওয়েব সার্ভিসের জন্য প্রয়োজনীয়)
app = Flask('')
...
# আপনার টোকেন ও এপিআই কি সরাসরি সেট করা আছে
...
# ব্যাকগ্রাউন্ডে সার্ভার এবং বট একসাথে চালানোর ট্রিক
